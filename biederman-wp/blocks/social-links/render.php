...
if (isset($biederman_current_block) && function_exists('get_block_wrapper_attributes')) {
  ...
  $wrapper_attributes = 'class="wp-block-biederman-social-links"';
}
...
?>
<div <?php echo $wrapper_attributes; ?> class="wp-block-biederman-social-links links links--social" aria-label="<?php esc_attr_e('Social Links', 'biederman'); ?>">
<?php
if ($instagram) {
